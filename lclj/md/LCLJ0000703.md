...
$\times10^{9}/\mathrm{L}$/L，可使用粒细胞集落刺激因子（$(\,\mathrm{G-CSF\,)\,5\,\upmu\mathrm{~g~}\bullet\mathrm{Kg}^{-1}\ \bullet\mathrm{d}^{-1}}$。  
# （九）出院标准。  
...
4.造血生长因子: 化疗后中性粒细胞绝对值（ $(\,\mathrm{ANC}\,)\ \leqslant$ 1$\downarrow.0\times10^{9}/\mathrm{L}$/L，可使用G-CSF 5μg·Kg$\mathrm{G-CSF\,\,\,5\upmu\mathrm{~g}\bullet\mathrm{Kg}^{-1}\,\,\bullet\mathrm{~d}^{-1}\circ}$。  
# （八）出院标准。  
1.一般情况良好。  
