...
RFH score${=}2.692{-}0.996\times6$variceal bleeding）$+0.003$ \times\ (\text{bilirubin}) + 0.358 \times (\text{INR}) + 0.136 \times (\text{lactate})
 $+0.004\times\left(A{\mathrm{-}}ag r a d i e n t\right)\ +0.036\times\left(u r e a\right)$  
