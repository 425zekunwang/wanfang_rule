...
长期以来钙被认为是结直肠腺瘤和结直肠癌的保护因素。McCullough 等在1992 年起5 年内随访60 866 名男性及66 883名女性，发现钙的摄入量与低结直肠癌发病率相关（$.R R{=}0.87$，$95\%C I\;0.67\sim1.12$，$P{=}0.02$）。Flood 等对45354 名女性的研究有类似结论，且进一步发现保护作用与摄入剂量相关。在临床应用方面，一项包含多个队列的荟萃分析提示，不论是总钙摄入量增加（$.R R{=}0.92$，$95\%C I\;0.89\sim0.95\}$）还是额外补充摄入量增加（$'R R{=}0.91$，$95\%C I\;0.86\sim0.98\,\rangle$），钙的摄入增加都能减少结直肠腺瘤的发生（R R=0.80，$95\%C I\;0.62 \sim 1.03\,\rangle$）。但是至今尚无优质RCT 研究评估钙剂的补充与结直肠腺瘤发病的关系，其仍需进一步的RCT 证据支持。  
