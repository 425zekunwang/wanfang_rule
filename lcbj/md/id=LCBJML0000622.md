...
Updated MELD $\scriptstyle1.266\,\times\,L n$ （ $1+$  肌酐） $+0.939\times L n$ （ $1+$ 胆红素）$+1.658\times L n$（${\mathrm{1+INR}}_{,}$）  
...
RFH score${=}2.692{-}0.996\times6$variceal bleeding）$+0.003$ $\times\ (b i l i r u b i n)\left.+0.358\times(I N R)\left.+0.136\times(l a c t a t e)\right.$ $+0.004\times\left(A{\mathrm{-}}a\,g r a d i e n t\right)\ +0.036\times\left(u r e a\right)$  
